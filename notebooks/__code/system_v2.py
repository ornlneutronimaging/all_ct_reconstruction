...
class System:
    ...
    def select_working_dir(cls, 
        ...
        list_and_default_folders = cls.get_list_folders(start_path=cls.start_path)
        user_list_folders = list_and_default_folders['user_list_folders']
        default_value = list_and_default_folders['default_value']
        logging.info(f"user_list_folders: {user_list_folders}")
        logging.info(f"default_value: {default_value}")
